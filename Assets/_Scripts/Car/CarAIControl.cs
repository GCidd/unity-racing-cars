...
public class CarAIControl : MonoBehaviour
{
    ...
    [SerializeField] [Range(0, 180)] private float m_CautiousMaxAngle = 180f;                  // angle of approaching corner to treat as warranting maximum caution
    ...
    {
        m_CautiousSpeedFactor = stats.m_CautiousSpeedFactor;
        m_CautiousMaxAngle = stats.m_CautiousMaxAngle;
        m_CautiousMaxDistance = stats.m_CautiousMaxDistance;
        m_CautiousAngularVelocityFactor = stats.m_CautiousAngularVelocityFactor;
        m_SteerSensitivity = stats.m_SteerSensitivity;
        m_AccelSensitivity = stats.m_AccelSensitivity;
        m_BrakeSensitivity = stats.m_BrakeSensitivity;
        m_LateralWanderDistance = stats.m_LateralWanderDistance;
        m_LateralWanderSpeed = stats.m_LateralWanderSpeed;
        m_AccelWanderAmount = stats.m_AccelWanderAmount;
        m_AccelWanderSpeed = stats.m_AccelWanderSpeed;
        m_BrakeCondition = stats.m_BrakeCondition;
        m_Driving = stats.m_Driving;
        m_StopWhenTargetReached = stats.m_StopWhenTargetReached;
        m_ReachTargetThreshold = stats.m_ReachTargetThreshold;
        m_RandomPerlin = stats.m_RandomPerlin;
        m_AvoidOtherCarTime = stats.m_AvoidOtherCarTime;
        m_AvoidOtherCarSlowdown = stats.m_AvoidOtherCarSlowdown;
        m_AvoidPathOffset = stats.m_AvoidPathOffset;
    }
    ...
    public void SetTarget(Transform target)
    {
        ...
        m_StopWhenTargetReached = false;
        m_AvoidOtherCarTime = 5;
        m_AvoidOtherCarSlowdown = 0.5f;
        m_AvoidPathOffset = 3f;
    }
}
